$(function() {
	...
	$('#play-media-icon').click(function(e) {
		...
		$('#media #media-close').addClass('fa fa-times close-icon');
	...
	$('#gallery-icon').click(function(e) {
		...
		$('#gallery #gallery-close').addClass('fa fa-times close-icon');
	...
	$('#contact-icon').click(function(e) {
		...
		$('#contact #contact-close').addClass('fa fa-times close-icon');
